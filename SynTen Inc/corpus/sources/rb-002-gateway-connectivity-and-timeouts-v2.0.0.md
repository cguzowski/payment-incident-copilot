...
type: RUNBOOK
title: Gateway Connectivity and Timeout Runbook
version: 2.0.0
...
replacement: None
requiredCodes: GATEWAY_TIMEOUT,RETRY_BUDGET_EXHAUSTED,UPSTREAM_CONNECTION_RESET
relatedDocuments: RB-006, RB-011, PL-006
generatorVersion: synten-pdf-generator/v1
---
# Gateway Connectivity and Timeout Runbook
...
| Related documents | RB-006, RB-011, PL-006 |
| Retrieval role | Primary guidance for timeout and connection-reset clusters. |
| Classification | Internal - Synthetic Demo |
...
This runbook guides a human analyst investigating gateway transport failures. Its operational purpose is: Primary guidance for timeout and connection-reset clusters. It applies only to persisted SynTen Inc synthetic evidence for the current tenant and investigation.
...
| S002 | HIGH | UPSTREAM_CONNECTION_RESET | The upstream gateway repeatedly reset established authorization connections. Confirm the stated required evidence before using this as probable cause. |
...
Use RB-006, RB-011, PL-006 for adjacent diagnostic or governance requirements. Only approved and effective versions are retrieval eligible.
