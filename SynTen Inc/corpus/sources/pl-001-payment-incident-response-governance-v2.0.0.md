...
| Related documents | PL-002, PL-003, RB-001 |
| Retrieval role | Core investigation, evidence, report, decision, and audit requirements. |
| Classification | Internal - Synthetic Demo |
...
This policy establishes mandatory SynTen Inc controls for authorization incident lifecycle and review. It supports auditable investigation of the synthetic authorization-decline incident family while preserving evidence integrity and human authority.
...
1. Every alert must retain detected and received timestamps and enter the tenant-scoped work queue before investigation.
2. Evidence collection, knowledge retrieval, report generation, and the human decision must remain separate auditable attempts.
3. Only a schema-valid report may enter AWAITING_REVIEW; schema validity does not establish factual correctness.
4. Approval or rejection must bind to the exact report under review and record an attributable synthetic operator and reason.

## 5. Roles and responsibilities

| Role | Responsible | Accountable | Consulted or informed |
|---|---|---|---|
| Incident Management | Maintain this policy and control evidence. | Approve content through the synthetic role account. | Incident Management and affected technical owners. |
...
Apply this policy with PL-002, PL-003, RB-001. Where guidance conflicts, use only the approved and effective version and preserve the conflict for audit.
