---
documentKey: PL-004
documentId: 1baf4e46-4833-48bc-aa6d-52ef8b2c4441
tenantId: 8b860d80-d17f-4e6b-8c48-af35f26a4d61
type: POLICY
title: Operational Knowledge Lifecycle and Approval Policy
version: 1.0.0
incidentFamily: AUTHORIZATION_DECLINE_RATE_SPIKE
appliesTo: Runbook/policy ownership, versions, and retrieval eligibility
approvalStatus: APPROVED
approvedBy: 7b636625-53d1-46f7-92a9-9c8c27a243d1
approvedAt: 2026-08-30T08:00:00Z
effectiveAt: 2026-08-30T09:00:00Z
ownerRole: Knowledge Governance
classification: Internal - Synthetic Demo
replacement: None
requiredCodes: None
relatedDocuments: PL-002, corpus/inventory.md
generatorVersion: synten-pdf-generator/v1
---
# Operational Knowledge Lifecycle and Approval Policy
...
| Related documents | PL-002, corpus/inventory.md |
| Retrieval role | Defines approval, effective version, supersession, review, and source provenance. |
| Classification | Internal - Synthetic Demo |
...
This policy establishes mandatory SynTen Inc controls for runbook/policy ownership, versions, and retrieval eligibility. It supports auditable investigation of the synthetic authorization-decline incident family while preserving evidence integrity and human authority.
...
1. Only APPROVED, effective, tenant-matching, incident-family-matching versions may enter lexical or vector ranking.
2. A source, metadata, extraction, or embedding-input change creates a new version and requires new hashes and embeddings.
3. SUPERSEDED material must remain auditable but must be excluded before ranking, even on an exact lexical match.
4. Every document must have an owner, review cadence, revision history, source hash, and approved replacement where applicable.

## 5. Roles and responsibilities

| Role | Responsible | Accountable | Consulted or informed |
|---|---|---|---|
| Knowledge Governance | Maintain this policy and control evidence. | Approve content through the synthetic role account. | Incident Management and affected technical owners. |
...
Apply this policy with PL-002, corpus/inventory.md. Where guidance conflicts, use only the approved and effective version and preserve the conflict for audit.
