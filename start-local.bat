...
set "OPERATIONS_MCP_BASE_URL=http://localhost:8082"

if /I "%~1"=="--CheckOnly" goto run_local_launcher
if /I "%~1"=="-CheckOnly" goto run_local_launcher
...
if not errorlevel 1 goto generator_ready
...
:run_local_launcher
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\start-local.ps1" -UseGeneratorMcp %*
