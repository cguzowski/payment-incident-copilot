...
class MarkdownKnowledgeChunkerTest {
    ...
    void splitsAtTargetWithOverlapOnlyInsideTheSameSection() {
        ...
        assertThat(chunks)
                .extracting(KnowledgeChunkDraft::sectionPath)
                .containsExactly("Gateway Failures", "Gateway Failures", "Gateway Failures", "Account Status");
        assertThat(chunks)
                .extracting(KnowledgeChunkDraft::rawContent)
                .containsExactly(
                        "## Gateway Failures\n\none two three four five",
                        "four five\n\nsix seven eight nine ten",
                        "nine ten\n\neleven twelve thirteen fourteen fifteen",
                        "## Account Status\n\nalpha beta gamma delta epsilon");
        assertThat(chunks)
                .allSatisfy(chunk -> assertThat(chunk.estimatedTokens()).isLessThanOrEqualTo(12));
