...
class KnowledgeHybridSearchPostgresIntegrationTest {
    ...
    void filtersBeforeIndependentRankingAndReturnsDeterministicRrfCandidates() {
        ...
        assertThat(candidates).extracting(KnowledgeSearchCandidate::documentType)
        ...
        assertThat(candidates.getFirst().fusedScore()).isGreaterThan(candidates.getLast().fusedScore());
    ...
    private void insertDocumentAndChunk(
        ...
        jdbcClient.sql("""
                ...
                .param("title", type == KnowledgeDocumentType.RUNBOOK
        ...
        jdbcClient.sql("""
                ...
                .param("embeddingInput", "Document: fixture\nSection: " + sectionPath
    ...
    private static String unitVector(int index) {
        return PostgresKnowledgeIndexRepository.vectorLiteral(unitVectorArray(index));
    }
    ...
    private static String normalizedVector(float first, float second) {
        ...
        vector[0] = first;
        vector[1] = second;
        return PostgresKnowledgeIndexRepository.vectorLiteral(vector);
    }
}
