...
class KnowledgeRetrievalApiPostgresIntegrationTest {
    ...
    void setUp() {
        ...
        assertThat(ingestionService.importApprovedSources())
                .isEqualTo(new KnowledgeImportSummary(0, 2, 0));
    ...
    void retrievesAndPersistsApprovedKnowledgeWithoutHoldingTransactionAcrossEmbedding() throws Exception {
        ...
        when(embeddingClient.embed(anyString())).thenAnswer(invocation -> {
            ...
            observedCommittedStartedAttempt.set(jdbcClient.sql("""
                            SELECT EXISTS (
        ...
        assertThat(jdbcClient.sql("SELECT COUNT(*) FROM knowledge_retrieval_result")
                        .query(Integer.class)
                        .single())
                .isEqualTo(7);
    ...
    void retriesAppendHistoryAndCrossTenantRequestCreatesNothing() throws Exception {
        ...
        assertThat(jdbcClient.sql("SELECT COUNT(*) FROM knowledge_retrieval_attempt")
                        .query(Integer.class)
                        .single())
                .isEqualTo(2);
    ...
    private int persistedChunkCount() {
        return jdbcClient.sql("SELECT COUNT(*) FROM knowledge_chunk")
                .query(Integer.class)
                .single();
    }
